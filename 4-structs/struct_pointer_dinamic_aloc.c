...
//declaração de um ponteiro para uma struct
struct Paciente* pPaciente; //o asterisco faz parte da tipagem 

int main(){
    //alocando memória para o ponteiro
    //a função malloc recebe um número de bytes e retorna um ponteiro para o início dos bytes alocados
    //"void*" quer dizer a afunção malloc funciona com qualquer tipo de variável, seja primitivo ou composto 
